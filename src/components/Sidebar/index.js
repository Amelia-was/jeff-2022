    ...
    return (
        <header className='flex row align-c-between'>
            ...
            <div className='flex row align-baseline justify-center-sm w-100 mt-2'>
                ...
                <a href={`${process.env.PUBLIC_URL}/CV/CV_Jeff_Hicks_short.pdf`} className='icon-link show-mobile' target='_blank' rel='noreferrer'>
                        <h3 className='ml-1 d-inl'>CV</h3>
                </a>
            </div>
            <p className={`about mt-1 ${!isMobileOpen && 'hide-mobile'}`}>
            I am an Assistant Professor in the Department of Management at UTSC with a cross-appointment to the Rotman School of Management. Contact: jeffrey.hicks@utoronto.ca
            </p>
            <p className='mt-2 hide-mobile bold'>You can download my CV 
                <a href={`${process.env.PUBLIC_URL}/CV/CV_Jeff_Hicks_short.pdf`} className='link-white mt-3' target='_blank' rel='noreferrer'>
                    here
                </a>
            </p>
