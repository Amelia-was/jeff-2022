    ...
    return (
        <header className='flex row align-c-between'>
            ...
            <div className='flex row align-baseline justify-center-sm w-100 mt-2'>
                ...
                <a href={`${process.env.PUBLIC_URL}/CV/CV-JeffHicks2.pdf`} className='icon-link show-mobile' target='_blank' rel='noreferrer'>
            ...
            <p className='mt-2 hide-mobile bold'>You can download my CV 
                <a href={`${process.env.PUBLIC_URL}/CV/CV-JeffHicks2.pdf`} className='link-white mt-3' target='_blank' rel='noreferrer'>
                    here
                </a>
            </p>
